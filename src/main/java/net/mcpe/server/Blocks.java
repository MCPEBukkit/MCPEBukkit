...
public class Block {
    ...
    public static void p() {
        ...
        //not yet MCPE! ;D REGISTRY.a(52, "mob_spawner", (new BlockMobSpawner()).c(5.0F).a(j).c("mobSpawner").H().d("mob_spawner"));
       ...
       //REGISTRY.a(123, "redSTONE_lamp", (new BlockRedSTONELamp(false)).c(0.3F).a(k).c("redSTONELight").a(CreativeModeTab.d).d("redSTONE_lamp_off"));
        ...
        //chest trap? REGISTRY.a(146, "trapped_chest", (new BlockChest(1)).c(2.5F).a(f).c("chestTrap"));
